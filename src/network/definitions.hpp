...
namespace RF24::Network
{
  ...
  enum HeaderMessage : uint8_t
  {
    ...
    MSG_NET_REQUEST_CONNECT         = 201,
    MSG_NET_REQUEST_CONNECT_ACK     = 202,
    MSG_NET_REQUEST_CONNECT_NACK    = 203,
    MSG_NET_REQUEST_DISCONNECT      = 204,
    MSG_NET_REQUEST_DISCONNECT_ACK  = 205,
    MSG_NET_REQUEST_DISCONNECT_NACK = 206,
